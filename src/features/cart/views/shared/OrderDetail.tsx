...
const OrderDetail = ({ item }: OrderDetailProps) => {
  ...
  return (
    ...
    <ScrollView style={styles.scrollView} contentContainerStyle={styles.container}>
      ...
      {item.orderServices.map((orderService: OrderService, index: number) => (
        <View key={index} style={styles.orderDetailRow}>
          ...
          <TextView style={styles.orderDetailRowTitle}>
            ...
            .slice(0, 3)
            .reverse()
            .reduce((acc: string, curr: Service, index: number) =>
      ...
      <View style={styles.orderDetailRow}>
        ...
        <TextView style={styles.orderDetailRowBoldTitle}>مجموع سفارش</TextView>
      </View>
