...
const SelectBoxView: React.FC<SelectBoxViewProps> = ({
  ...
  const boxBackgroundColor = backgroundColor || theme.background || variantStyles.backgroundColor;
  ...
  const selectedColor = selectedOptionColor || variantStyles.selectedOptionColor;
  ...
  // Clean up search query when drawer closes
  useEffect(() => {
    if (!isOpen) {
      setSearchQuery('');
    }
      ...
      <View style={styles.contentContainer}>
        <TextView
          style={[
            styles.selectedText,
            sizeStyles.text,
            { color: selectedOption ? finalTextColor : variantStyles.placeholderColor },
            textStyle,
          ]}
          numberOfLines={1}
        >
    ...
    return (
      ...
      >
        ...
        <View style={styles.drawerHeader}>
          ...
          <TextView style={styles.drawerTitle}>
            {placeholder}
          </TextView>
        </View>
        ...
        >
          {filteredOptions.length === 0 ? (
            <View style={styles.noOptionsContainer}>
              <TextView style={styles.noOptionsText}>No options available</TextView>
            </View>
          ) : (
