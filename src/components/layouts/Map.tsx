  ...
  return (
    <View style={styles.container}>
      ...
      <MapView
        ...
        onLongPress={(address) => setPosition(prev => 'coordinates' in address.geometry ? (address.geometry?.coordinates as number[]) : prev)}
      ...
      >
        ...
        />
        <PointAnnotation id={'id124'} coordinate={position}  draggable onDragEnd={(payload) => setPosition(payload.geometry.coordinates)}>
          <Image style={{
            width: 60,
            height: 60
